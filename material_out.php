...
?>
  ...
  <div class="container-fluid">
              ...
              <p class="text-white" id="date"><?php echo "Hi, User! "?>Today is <span><?php $date = date('M d, Y'); echo $date; ?></span></p>
                ...
                <div class="scanresultdiv">
                  ...
                  <div style="padding-top: 20px; margin-top: 3px;" id="formDiv" class="bg-dark">
                  <?php   
                    include 'material_out_info.php';
                  ?>
                  </div> <!--div for Material INFO LIKE GOODS_CODE, ITEM_CODE, PARTNAME/NUMBER, ETC. (AJAX)-->
